            ...
            <nav className="flex flex-row items-center justify-between py-5 px-4 md:px-10">
                ...
                <div className="hidden md:flex items-center space-x-3">
                    <button 
                        ...
                        className="text-black from-neutral-900 rounded-full border-0 px-3 py-2 hover:bg-gray-200"
                    >
                        {t('nav.becomeHost')}
                    </button>
                    {/* Language Dropdown */}
                        ...
                        {openLang && (
                            <div className="absolute right-0 mt-2 w-32 bg-white border rounded-lg shadow-lg z-20">
                                <button 
                                    ...
                                    className={`block w-full text-left px-4 py-2 hover:bg-gray-100 ${locale === 'en' ? 'bg-gray-100 font-medium' : ''}`}
                                >
                                    {t('lang.english')}
                                </button>
                                <button 
                                    onClick={() => changeLanguage("bn")} 
                                    className={`block w-full text-left px-4 py-2 hover:bg-gray-100 ${locale === 'bn' ? 'bg-gray-100 font-medium' : ''}`}
                                >
                                    {t('lang.bangla')}
                                </button>
                            </div>
                ...
                <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
                    <div className="w-[1000px] h-[600px] bg-white px-15 py-20 rounded-3xl">
                        ...
                        <h3 className="text-center text-3xl font-bold pt-6 py-20">{t('modal.title')}</h3>
                        <div className="grid grid-cols-3 gap-3">
                            {/* Home */}
                            <div className="border-2 p-12 flex flex-col items-center justify-center rounded-xl border-gray-300 gap-5 cursor-pointer hover:border-gray-500 transition-colors">
                                <FcHome className="text-8xl mr-1" />
                                <h3 className="text-center">{t('modal.home')}</h3>
                            </div>

                            {/* Experiences */}
                            <div className="border-2 border-gray-300 rounded-xl flex flex-col items-center justify-center gap-5 p-12 cursor-pointer hover:border-gray-500 transition-colors">
                                <img
                                    src="hot-air-balloon.png"
                                    alt=""
                                    className="mr-1 w-20 h-20"
                                />
                                <h3>{t('modal.experience')}</h3>
                            </div>
                            ...
                            <div className="border-2 border-gray-300 rounded-xl flex flex-col items-center justify-center gap-5 p-12 cursor-pointer hover:border-gray-500 transition-colors">
                                <img
                                    ...
                                    className="mr-1 w-20 h-20"
                                />
                                <h3>{t('modal.service')}</h3>
                            </div>
                        </div>
                        <div className="modal-action pt-8">
                            <form method="dialog">
                                <button className="btn p-8 rounded-2xl text-xl text-white" disabled>
                                    {t('modal.next')}
                                </button>
                            </form>
                        </div>
